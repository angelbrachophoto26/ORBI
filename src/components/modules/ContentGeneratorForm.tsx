...
function CopyButton({ text, label }: { text: string; label?: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="flex items-center gap-1.5 text-xs px-2 py-1 rounded text-orbi-muted hover:text-slate-300 hover:bg-orbi-primary transition-colors"
    >
    ...
    <div className={`rounded-xl border border-orbi-border bg-orbi-surface/60 ${regenerating ? "opacity-50 pointer-events-none" : ""}`}>
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <button onClick={() => setExpanded(v => !v)} className="text-orbi-muted hover:text-slate-300 transition-colors">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-orbi-border-light text-orbi-muted hover:border-slate-600 hover:text-white transition-colors"
          >
            <Copy className="w-3.5 h-3.5" /> Copiar Markdown
          </button>
          <button
            onClick={generate}
            className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-orbi-border text-orbi-muted hover:border-orbi-border-light hover:text-slate-300 transition-colors"
          >
